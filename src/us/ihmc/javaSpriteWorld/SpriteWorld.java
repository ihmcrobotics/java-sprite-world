...
public class SpriteWorld
{
   ...
   {
      if (spriteCollisionGroups == null) return;
   ...
   public SpriteWorldViewerUsingJavaFX createAndDisplaySpriteWorldViewerUsingJavaFX(String name, SpriteWorld spriteWorld, int preferredWidth, int preferredHeight)
   {
